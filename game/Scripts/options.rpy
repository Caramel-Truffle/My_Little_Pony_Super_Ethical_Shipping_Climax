...
init -1 python hide:
    ...
    config.window_icon = "Images/other_icon.png"
    config.windows_icon = "Images/win_icon.png"
...
python early:
    config.save_directory = "My Little Pony Super Ethical Shipping Climax-1372450321"
...
init python:
    ...
    build.directory_name = "My_Little_Pony_Super_Ethical_Shipping_Climax_beta"
