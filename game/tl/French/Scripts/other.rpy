...
translate French eegg_a3cfa20f:

    # "Congratulations! You just unlocked the Big Macintosh mode!"
    "Félicitations! Vous venez de déverrouiller le mode Big Macintosh!"

# game/Scripts/other.rpy:17
translate French eegg_98839ad5:

    # "Are you happy?"
    "Êtes-vous heureux?"

# game/Scripts/other.rpy:22
translate French eeggfun_617adff3:

    # p "Eeyup"
    p "Eeyup"

# game/Scripts/other.rpy:23
translate French eeggfun_8c893ddc:

    # "That's the spirit."
    "C'est le principe."

# game/Scripts/other.rpy:25
translate French eeggfun_50810729:

    # p "Nope."
    p "Nope."

# game/Scripts/other.rpy:26
translate French eeggfun_fe477e99:

    # "Your happiness is not relevant anyway."
    "Votre bonheur n'est pas pertinent de toute façon."

# game/Scripts/other.rpy:27
translate French eeggfun_cedc109b:
...
translate French eeggfun_5ae4dd33:

    # p "Eeyup?"
    p "Eeyup?"

# game/Scripts/other.rpy:52
translate French bm_place_choice_fa462d1f:

    # "You were going to leave the crossroad when suddenly..."
    "Vous aliez quitter le carrefour quand tout à coup..."

# game/Scripts/other.rpy:54
translate French bm_place_choice_c7e2834e:

    # u "WAIIIIIIIIIIT!"
    u "ATTEEEEEEEEEENDS!"

# game/Scripts/other.rpy:59
translate French bm_place_choice_ae2f7e3d:

    # "What's that? It's not in the script!"
    "Qu'est-ce que c'est? Ce n'est pas dans le script!"

# game/Scripts/other.rpy:60
translate French bm_place_choice_bf12372d:

    # p "Eeyup."
    p "Eeyup."

# game/Scripts/other.rpy:65
translate French bm_place_choice_bdd200b6:

    # cmc "Big Mac! You are here!"
    cmc "Big Mac! Tu es là!"

# game/Scripts/other.rpy:66
translate French bm_place_choice_bf12372d_1:

    # p "Eeyup."
    p "Eeyup."

# game/Scripts/other.rpy:67
translate French bm_place_choice_592959da:

    # sb "You don't have any plan for tonight, do you?"
    "Tu n'as pas de plan pour ce soir, n'est-ce pas?"

# game/Scripts/other.rpy:68
translate French bm_place_choice_50810729:

    # p "Nope."
    p "Nope."

# game/Scripts/other.rpy:69
translate French bm_place_choice_e747cf69:

    # s "Great! We found you the perfect date! Promise!"
    s "Génial! On t'a trouvé le rendez-vous idéal! Promis!"

# game/Scripts/other.rpy:70
translate French bm_place_choice_1a89e756:
...
translate French bm_place_choice_7533a892:

    # s "...With Miss Cherilee and all..."
    s "... avec Miss Cherilee et tout ..."

# game/Scripts/other.rpy:72
translate French bm_place_choice_5b2c85d8:
...
translate French bm_place_choice_975d5d61:

    # cmc "What do you think, Big Mac? Do you accept?"
    cmc "Qu'en penses-tu, Big Mac? Est-ce que tu acceptes?"

# game/Scripts/other.rpy:78
translate French cmcdecision_bf12372d:

    # p "Eeyup."
    p "Eeyup."

# game/Scripts/other.rpy:81
translate French cmcdecision_059c1555:

    # cmc "CUTIE MARK CRUSADERS, SECRET SHIPPERS! YAAAY!"
    cmc "CUTIE MARK CRUSADERS, SHIPPERS SECRETS! YAAAY!"

# game/Scripts/other.rpy:84
translate French cmcdecision_2d6b7fab:

    # sb "You won't regret it!"
    sb "Tu ne le regretteras pas!"

# game/Scripts/other.rpy:85
translate French cmcdecision_2fdeeefd:

    # ab "Promise!"
    ab "Promis!"

# game/Scripts/other.rpy:88
translate French cmcdecision_50810729:

    # p "Nope."
    p "Nope."

# game/Scripts/other.rpy:91
translate French cmcdecision_630503a1:

    # cmc "PLEAAAAAAAAAAAAAAAAAAAAAAASE!"
    cmc "STE PLAIIIIIIIIIIIIIIIIIIIIIT!"

# game/Scripts/other.rpy:97
translate French cmcdecision_bbeed607:

    # "An easter egg inside an easter egg! Wow!"
    "Un easter egg dans un easter egg! Wow!"

# game/Scripts/other.rpy:99
translate French cmcdecision_90cbc330:

    # "Okay, you deserved it. this is your cupboard ending."
    "D'accord, tu le mérites. C'est la fin dans ton placard."

# game/Scripts/other.rpy:103
translate French cmcdecision_28e92ce6:

    # "Seen from up close. Congrats!"
    "Vu de près. Félicitations!"

# game/Scripts/other.rpy:105
translate French cmcdecision_bde1a939:

    # "--Cupboard Ending--"
    "--Fin dans le placard--"

# game/Scripts/other.rpy:108
translate French cmcdecision_dda0287c:
...
translate French cmcdecision_2457cbc6:

    # "And the three fillies took you to the edge of the town, with nothing else than trees, grass and..."
    "Et les trois pouliches vous ont emmené au bord de la ville, avec rien d'autre que des arbres, de l'herbe et ..."

# game/Scripts/other.rpy:121
translate French cmcdecision_ad7d903f:

    # b "Heeeeey! Welcome to Appleloosa cousin!"
    b "Heeeeey! Bienvenue à Appleloosa, cousin!"

# game/Scripts/other.rpy:122
translate French cmcdecision_50810729_1:

    # p "Nope."
    p "Nope."

# game/Scripts/other.rpy:123
translate French cmcdecision_ba34d4e5:
...
translate French cmcdecision_bf12372d_1:

    # p "Eeyup."
    p "Eeyup."

# game/Scripts/other.rpy:125
translate French cmcdecision_6c9055d4:

    # b "I tried hard to have your attention, even got these sunglasses. Do you want to try now?"
    b "J'ai tout fait pour attirer ton attention, même porter ces lunettes de soleil. Veux-tu essayer maintenant?"

# game/Scripts/other.rpy:130
translate French braeburnchoice_bf12372d:
...
translate French braeburnchoice_0a77af13:

    # cmc "Awwwwwwww!"
    cmc "Awwwwwwww!"

# game/Scripts/other.rpy:144
translate French braeburnchoice_8945fab8:

    # "Girls, you are creepy."
    "Les filles, vous êtes effrayantes."

# game/Scripts/other.rpy:146
translate French braeburnchoice_7d3f6444:

    # "--Braeburn ending 0--"
    "--Braeburn fin 0--"

# game/Scripts/other.rpy:150
translate French braeburnchoice_50810729:

    # p "Nope."
    p "Nope."

# game/Scripts/other.rpy:151
translate French braeburnchoice_fc0bc7e1:

    # b "Come on cousin! Gimme a kiss!"
    b "Allez, mon cousin! Donne-moi un baiser! Chez nous c'est 420 sur chaque joue!"

# game/Scripts/other.rpy:152
translate French braeburnchoice_50810729_1:

    # p "Nope."
    p "Nope."

# game/Scripts/other.rpy:159
translate French braeburnchoice_1e381603:

    # nr "BRAEBURN! Stop drinking, you are not allowed to!"
    nr "BRAEBURN! Arrêtez de boire, vous n'avez pas le droit!"

# game/Scripts/other.rpy:160
translate French braeburnchoice_5e90538c:

    # b "Come on nurse! That's just one glass... And now gimme a hug!"
    b "Allons, infirmière! Ce n'est qu'un verre... Et maintenant, donne-moi un câlin!"

# game/Scripts/other.rpy:161
translate French braeburnchoice_4a0aaad0:

    # nr "You are drunk Braeburn. And now you won't be able to take your medication for tonight and that's bad."
    nr "Vous êtes complèetement saoûl, Braeburn. Et maintenant vous ne pourrez pas prendre vos médicaments ce soir et c'est dangereux."

# game/Scripts/other.rpy:162
translate French braeburnchoice_bf12372d_1:

    # p "Eeyup."
    p "Eeyup."

# game/Scripts/other.rpy:165
translate French braeburnchoice_cc595ec5:
    ...
    nr "Désolé, je ne vous ai pas remarqué... Big Mac, n'est-ce pas? Braeburn a attrapé une sorte de grippe locale et n'aurait pas dû quitter l'hôpital comme il l'a fait. Mais maintenant, en vous regardant, je comprends un peu ses motivations."

# game/Scripts/other.rpy:168
translate French braeburnchoice_e12cfdef:

    # nr "I'm going to get back to the hospital with him, would you like to come with us?"
    nr "Je vais retourner à l'hôpital avec lui, voudriez-vous venir avec nous?"

# game/Scripts/other.rpy:169
translate French braeburnchoice_bf12372d_2:

    # p "Eeyup."
    p "Eeyup."

# game/Scripts/other.rpy:170
translate French braeburnchoice_9b9b0794:

    # nr "Let's go then!"
    nr "Allons-y alors!"

# game/Scripts/other.rpy:176
translate French braeburnchoice_02681465:
