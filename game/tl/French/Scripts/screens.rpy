...
translate French strings:
    ...
    new "Créé avec {a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only].\n\n[renpy.license!t]"
    ...
    new "Avance le dialogue sans faire de choix."
    ...
    new "Saute le dialogue quand enfoncé."
    ...
    new "Active le dialogue en sautant."
    ...
    new "Active / désactive l’auto-expression {a=https://www.renpy.org/l/voicing}self-voicing{/a}."
    ...
    old "Mouse Wheel Up\nClick Rollback Side"
    new "Roulette de souris vers le haut \ nCliquez sur le côté droit"
    ...
    old "Right Trigger\nA/Bottom Button"
    new "Bouton de déclenchement droit\nA/bas"
