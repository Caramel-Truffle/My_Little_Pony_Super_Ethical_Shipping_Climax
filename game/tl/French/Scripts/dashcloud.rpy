...
translate French easyflutterdash_a364db8b:
    ...
    rd "Laisse-moi te mettre dans un contexte, d'abord. Imagine si tu voulais paraître plus gentil. Tu connais le principe du lovely item? Quelque chose de mignon qui te fait paraitre gentil?"
...
translate French truederpyabuse_abbefd25:
    ...
    rd "Peu importe. Tu viens chez moi. Prétends que tu es moi. Et essaie d'abuser de mes amis? SORS!"
...
translate French truederpyabuse_ba5260a6:

    # d "Hey [playername2]! Rainbow Dash and me were going to go train for a bit, do you want to join us?"
    d "Hey [playername2]! Rainbow Dash et moi allions nous entraîner un peu, veux-tu nous rejoindre?"
...
translate French truederpyabuse_77df56a3:
...
translate French dashcloud_09477f07:
    ...
    p "C'est pratique d'avoir des ailes, [playername!t] était un bon choix."

# game/Scripts/dashcloud.rpy:12
translate French dashcloud_859397e4:

    # p "Magic is useful, [playername!t] was a good choice."
    p "C'est pratique d'avoir des pouvoirs magiques, [playername!t] était un bon choix."

# game/Scripts/dashcloud.rpy:47
translate French datdashplot_f2278cf7:

    # rd "Are you just passing by [playername3!t], or do you need something?"
    rd "Es-tu juste de passage [playername3!t], ou voulais-tu quelque chose?"
...
translate French truederpyabuse_48911279:
    ...
    d "Hey [playername2!t]! Rainbow Dash et moi allions nous entrainer, veux-tu nous rejoindre?"
