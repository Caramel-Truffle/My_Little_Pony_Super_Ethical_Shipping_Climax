...
translate French strings:
    ...
    new "Cliquez pour lire la vidéo"
    ...
    new "Synthèse vocale du presse-papiers activée"
    ...
    new "La synthèse vocale est limitée lors de l'utilisation d'un écran tactile"
    ...
    new "Réduction du volume de la synthèse vocale"
    ...
    new "Menu d'accessibilité. Utilisez les flèches haut et bas pour naviguer, et entrée pour activer les boutons et barres"

    # renpy/common/00accessibility.rpy:288
    old "Self-Voicing and Audio"
    new "Synthèse vocale et audio"
    ...
    new "Les options de ce menu sont destinées à améliorer l'accessibilité. Elles peuvent ne pas fonctionner avec tous les jeux, et certaines combinaisons d'options peuvent rendre le jeu injouable. Ce n'est pas un problème avec le jeu ou le moteur. Pour de meilleurs résultats lors du changement de polices, essayez de conserver la même taille de texte qu'à l'origine"
    ...
    old "File page auto"
    new "Page de fichiers auto"

    # renpy/common/00action_file.rpy:615
    old "File page quick"
    new "Page de fichiers rapide"
    ...
    new "Cliquez pour basculer l'attribut, clic droit pour basculer l'attribut négatif"
    ...
    new "Cliquez pour définir la transformation, clic droit pour ajouter à la liste"

    # renpy/common/00director.rpy:1777
    old "Customize director.transforms to add more transforms."
    new "Personnalisez director.transforms pour ajouter plus de transformations"
    ...
    new "Cliquez pour définir, clic droit pour ajouter à la liste arrière"
    ...
    new "Personnalisez director.transitions pour ajouter plus de transitions"
    ...
    new "Personnalisez director.audio_channels pour ajouter plus de canaux"
    ...
    new "Le chargement effacera les progrès non sauvegardés.\nÊtes-vous sûr de vouloir continuer?"
    ...
    new "Êtes-vous sûr de vouloir passer au prochain choix?"

    # renpy/common/00gui.rpy:458
    old "Are you sure you want to skip unseen dialogue to the next choice?"
    new "Êtes-vous sûr de vouloir passer les dialogues non vus jusqu'au prochain choix?"

    # renpy/common/00gui.rpy:459
    old "This save was created on a different device. Maliciously constructed save files can harm your computer. Do you trust this save's creator and everyone who could have changed the file?"
    new "Cette sauvegarde a été créée sur un autre appareil. Des fichiers de sauvegarde malveillants peuvent endommager votre ordinateur. Faites-vous confiance au créateur de cette sauvegarde et à toutes les personnes qui ont pu modifier le fichier?"

    # renpy/common/00gui.rpy:460
    old "Do you trust the device the save was created on? You should only choose yes if you are the device's sole user."
    new "Faites-vous confiance à l'appareil sur lequel la sauvegarde a été créée? Vous ne devriez choisir oui que si vous êtes le seul utilisateur de l'appareil"
    ...
    new "Ce programme contient des logiciels libres sous plusieurs licences, notamment la licence MIT et la licence publique générale limitée GNU. Une liste complète des logiciels, avec des liens vers le code source complet, peut être trouvée {a=https://www.renpy.org/l/license}ici{/a}"
    ...
    new "passer non vu [text]"

    # renpy/common/00preferences.rpy:367
    old "skip unseen text"
    new "passer texte non vu"
    ...
    new "activer synthèse vocale"

    # renpy/common/00preferences.rpy:447
    old "self voicing disable"
    new "désactiver synthèse vocale"

    # renpy/common/00preferences.rpy:451
    old "self voicing volume drop"
    new "réduction volume synthèse vocale"

    # renpy/common/00preferences.rpy:459
    old "clipboard voicing"
    new "synthèse vocale presse-papiers"

    # renpy/common/00preferences.rpy:462
    old "clipboard voicing enable"
    new "activer synthèse vocale presse-papiers"

    # renpy/common/00preferences.rpy:464
    old "clipboard voicing disable"
    new "désactiver synthèse vocale presse-papiers"

    # renpy/common/00preferences.rpy:468
    old "debug voicing"
    new "synthèse vocale débogage"

    # renpy/common/00preferences.rpy:471
    old "debug voicing enable"
    new "activer synthèse vocale débogage"

    # renpy/common/00preferences.rpy:473
    old "debug voicing disable"
    new "désactiver synthèse vocale débogage"
    ...
    new "Synthèse vocale du presse-papiers activée. Appuyez sur 'shift+C' pour désactiver."

    # renpy/common/00preferences.rpy:725
    old "Self-voicing would say \"[renpy.display.tts.last]\". Press 'alt+shift+V' to disable."
    new "La synthèse vocale dirait \"[renpy.display.tts.last]\". Appuyez sur 'alt+shift+V' pour désactiver."

    # renpy/common/00preferences.rpy:727
    old "Self-voicing enabled. Press 'v' to disable."
    new "Synthèse vocale activée. Appuyez sur 'v' pour désactiver."
    ...
    new "(effacer les bulles conservées)"
    ...
    new "Une erreur inconnue est survenue lors de la connexion au serveur de synchronisation Ren'Py."

    # renpy/common/00sync.rpy:204
    old "The Ren'Py Sync server does not have a copy of this sync. The sync ID may be invalid, or it may have timed out."
    new "Le serveur de synchronisation Ren'Py n'a pas de copie de cette synchronisation. L'ID de synchronisation est peut-être invalide ou a expiré."

    # renpy/common/00sync.rpy:305
    old "Please enter the sync ID you generated.\nNever enter a sync ID you didn't create yourself."
    new "Veuillez entrer l'ID de synchronisation que vous avez généré.\nN'entrez jamais un ID de synchronisation que vous n'avez pas créé vous-même."

    # renpy/common/00sync.rpy:324
    old "The sync ID is not in the correct format."
    new "L'ID de synchronisation n'est pas au bon format."
    ...
    new "La synchronisation contient un fichier avec un nom invalide."

    # renpy/common/00sync.rpy:425
    old "This will upload your saves to the {a=https://sync.renpy.org}Ren'Py Sync Server{/a}.\nDo you want to continue?"
    new "Cela téléchargera vos sauvegardes sur le {a=https://sync.renpy.org}serveur de synchronisation Ren'Py{/a}.\nVoulez-vous continuer ?"
    ...
    old "Enter Sync ID"
    new "Entrer l'ID de synchronisation"
    ...
    new "Le condensé de la liste des fichiers ne correspond pas."
    ...
    new "Lors du dépaquetage de {}, type inconnu {}."
    ...
    new "Une erreur est survenue lors de la tentative de téléchargement des données du jeu :"
    ...
    new "Cet ordinateur a un problème d'affichage des graphismes : [problem]."
    ...
    new "Plus de détails sur la façon de corriger cela peuvent être trouvés dans la {a=[url]}documentation{/a}."
    ...
    new "Sélectionner la manette à calibrer"
    ...
    new "Copie le fichier traceback.txt dans le presse-papiers sous forme de BBcode pour des forums comme https://lemmasoft.renai.us/."
    ...
    new "Copie le fichier traceback.txt dans le presse-papiers sous forme de Markdown pour Discord."
    ...
    new "Tente un retour en arrière à un moment antérieur, vous permettant de sauvegarder ou de faire un choix différent."
    ...
    new "Recharge le jeu depuis le disque, en sauvegardant et en restaurant l'état du jeu si possible."
    ...
    new "Ouvre une console pour permettre de déboguer le problème."
