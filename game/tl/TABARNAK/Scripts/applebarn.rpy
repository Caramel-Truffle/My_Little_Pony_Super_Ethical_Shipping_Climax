...
translate TABARNAK applebarn_8a4553f0:
    ...
    "Après avoir marché un peu, tu arrives à la Grange Apple du verger Sweet Apple Acres."
...
translate TABARNAK aj_see_herself_c65736d1:
    ...
    # p "It's-a me! Rose! Isn't my cosplay great? Uh? Uh?"
    p "c'est moé! Rose! J'ai réussi mon cosplay, pas vrai?"

# game/Scripts/applebarn.rpy:24
translate TABARNAK aj_see_herself_4bd14ae3:

    # aj "Rose? This isn't one of Crépuscule's conventions, you know?"
    aj "Rose? On est pas à une des conventions de Crépuscule, t'sais?"
...
translate TABARNAK aj_see_herself_62f3df1a:
    ...
    aj "Ben, t'fais d'jà partie d'la famille... S'tu veux, j'peux t'appeler [playername3] juste pour aujourd'hui, Rose."

# game/Scripts/applebarn.rpy:33
translate TABARNAK aj_see_herself_792ed233:

    # p "Woohoo! You're the best, PommeJacques!"
    p "Woohoo! T'es la meilleure, PommeJacques!"
...
translate TABARNAK aj_see_herself_23502966:
    ...
    # "You touched her to the core, bravo! Unfortunately, you had nothing else than bittersweet hugs this day. PommeJacques wouldn't let you go after that."
    "Tu l'as touchée au plus profond, bravo! Malheureusement, vous avez passé le reste de la journée à vous câliner tristement. PommeJacques ne te laissa pas partir après ça."
...
translate TABARNAK aj_see_herself_f9807e4e:
    ...
    # aj "So we're both PommeJacques?"
    aj "On est toutes deux PommeJacques?"
...
translate TABARNAK sugapple_8d77fb92:
    ...
    "Et ainsi tu arrives à la table la plus proche, pour calmer ton estomac."
...
translate TABARNAK sugapple_91b94352:
    ...
    "Beaucoup de poneys sont ici, discutant, jouant, dansant... Mais pour le moment, tu portes ton attention sur une tarte aux pommes."
...
translate TABARNAK sugapple_bdbab47c:
    ...
    u "Ah, désolé mad'moiselle, j'pensais que t'étais notre bonne vieille PJ."

# game/Scripts/applebarn.rpy:119
translate TABARNAK sugapple_da79eff4:

    # p "I am! But I'm not. My name is PommeJacques, I look like the PommeJacques you know, but I'm not her. Look, she's just over there, talking to Honeycrisp!"
    p "Je le suis! Mais non. Mon nom est PommeJacques, je ressemble à celle que tu connais, mais je ne suis pas elle. Regarde, elle est juste là, à parler avec MielCrousillant!"

# game/Scripts/applebarn.rpy:120
translate TABARNAK sugapple_276da7de:

    # "You point out the real PommeJacques to the pony."
    "Tu pointes du sabot la véritable PommeJacques."
...
translate TABARNAK sugapple_535670f0:
    ...
    p "Oui, avec Fleuraimont, la chanson \"Tu dois partager\" et tout ça..."
...
translate TABARNAK braeburncest_701ba413:
    ...
    "Et t'es tous deux allé jouer à \"bisou-bisou les cousins\". Sauf que vous n'êtes pas vraiment cousins."
...
translate TABARNAK braeburncest_7fa749b5:
    ...
    "...Et puis avez mangé, sans parler à qui que ce soit. Après ça, t'es revenus à la croisée des chemins."
...
translate TABARNAK braeburncest_56107e09:
    ...
    # aj "You're not Arc-en-ciel, but you know what saying this means, don't you [playername3]?"
    aj "Tu n'es pas Arc-en-ciel, mais tu sais ce que ça veut dire, pas vrai [playername3]?"
...
translate TABARNAK waterapple_6080589b:
    ...
    "Essayer de faire de ton mieux, eh? Voyons le résultat."
...
translate TABARNAK waterapple_116456a6:
    ...
    # p "I am! But I'm not. My name is PommeJacques, I look like the PommeJacques you know, but I'm not her. Look, she's just over there, talking to... Where is she?"
    p "Je le suis! Mais je ne le suis pas. Mon nom est PommeJacques, je ressemble à PommeJacques, mais je ne suis pas elle. Regarde, elle est juste là-bas, en train de parler à... Où est-elle?"
...
translate TABARNAK waterapple_f2e9394f:
    ...
    # "You added a wink to your last comment."
    "Tu as ajouté un clin d'oeil à ton dernier commentaire."
...
translate TABARNAK cute_bb_7456e19d:
    ...
    b "Oh. Je ne pensais pas que tu aimais seulement les juments, désolé cube de sucre!"
...
translate TABARNAK brae_reward_b9431735:
    ...
    "Et t'es rentré sans chercher Braeburn."
...
translate TABARNAK brae_reward_9c5d0dfe:
    ...
    # "--PommeJacques true ending--"
    "--PommeJacques vraie fin--"

# game/Scripts/applebarn.rpy:553
translate TABARNAK brae_reward_8a4553f0:

    # "After walking for a bit, you arrive at the Apple barn in Sweet Apple Acres."
    "Après avoir marché un peu, tu arrives à la grange Apple à Sweet Apple Acres."
...
translate TABARNAK strings:
    ...
    old "\"It's-a me! Rose!\""
    new "\"Tu croyais que c'était toé, mais c'était moé! Rose!\""
...
# game/Scripts/applebarn.rpy:32
translate TABARNAK aj_see_herself_e031e6a2:
...
# game/Scripts/applebarn.rpy:88
translate TABARNAK aj_see_herself_3a5386dc:
...
# game/Scripts/applebarn.rpy:182
translate TABARNAK braeburncest_d3ba3e3f:

    # aj "You're not Arc-en-ciel, but you know what saying this means, don't you [playername3!t]?"
    aj "Tu n'es pas Arc-en-ciel, mais tu sais ce que dire ceci signifie, pas vrai [playername3!t]?"

# game/Scripts/applebarn.rpy:201
translate TABARNAK braeburncest_1ff5a80d:
...
# game/Scripts/applebarn.rpy:416
translate TABARNAK cute_bb_d3d882cc:

    # b "Welcome back [playername2!t]!"
    b "Bon retour [playername2!t]!"

# game/Scripts/applebarn.rpy:459
translate TABARNAK brae_reward_dd2ff640:

    # b "I sure do [playername2!t], but that's not really up to me."
    b "Pour sûr [playername2!t], mais ce n'est pas à moé de décider."
