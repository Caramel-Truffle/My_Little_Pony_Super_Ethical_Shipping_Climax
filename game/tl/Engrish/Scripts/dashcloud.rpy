...
translate Engrish dashcloud_89abc92a:
    ...
    "Like pegasus, you are able to run in the cloud."

# game/Scripts/dashcloud.rpy:9
translate Engrish dashcloud_bfbae56c:

    # p "Wings are useful, [playername] was a good choice."
    p "Wings useful, [username] is a good choice."
...
translate Engrish dashcloud_817a4c8f:
    ...
    "As a musical instrument, you are able to control the drug so that you can climb into the cloud so that it does not fall into it."

# game/Scripts/dashcloud.rpy:12
translate Engrish dashcloud_5fbc2be3:

    # p "Magic is useful, [playername] was a good choice."
    p "Creative magic, [username] is a good choice."
...
translate Engrish dashcloud_36385248:
    ...
    "Nevertheless, Rainbow Dash was there, looking for something under her bed, obviously she had not seen you."
...
translate Engrish datdashplot_dc115e3a:
    ...
    "You look for a moment, and kill your lips when it is enjoyable. Oh, every word and every choice-"
...
translate Engrish datdashplot_f5ce8270:
    ...
    "She's grunt, because she obviously did not find what she was looking for."
...
translate Engrish datdashplot_b4af8ed3:
    ...
    "Can you make one of my dreams come true and call me a rainbow?"
...
translate Engrish datdashplot_724d5b96:
    ...
    rd "You are a true worshiper! I want that! OK, but for today. Tomorrow will I call you by your real name, then correct?"
...
translate Engrish datdashplot_9e578579:

    # rd "Are you just passing by [playername3], or do you need something?"
    rd "Are you crossing through [username], or do you want something?"
...
translate Engrish datdashplot_20f4f91e:
    ...
    rd "Do you need help with the library? I've heard that this is the year of the year when you edit all the books."
...
translate Engrish datdashplot_e07f6bc8:
    ...
    rd "Please tell me that you do not want a model to create a fabric!"
...
translate Engrish easyflutterdash_a71491a4:
    ...
    rd "Of course? That's so bright! Thanks Fluttershy!"
...
translate Engrish easyflutterdash_f02d2de8:
    ...
    "Then both of you did bad things, and the bed was so close to ignoring it."
...
translate Engrish easyflutterdash_491425f7:
    ...
    "I do not miss your pictures in this matter."
...
translate Engrish easyflutterdash_f3d221c5:
    ...
    "Chibi spends a different way. This is not 18+ games all the time."
...
translate Engrish easyflutterdash_2f733bb2:
    ...
    p "Do you have a good deal to borrow?"
...
translate Engrish easyflutterdash_3c47e800:
    ...
    rd "Okay ... I hope you'll tell me everything about tomorrow."
...
translate Engrish easyflutterdash_741ca70e:
    ...
    "Yes, it's fun and everything, but I promise Derpy to go with me today, so I'll work hard every day."
...
translate Engrish easyflutterdash_59d81184:
    ...
    "He also told you to leave before it happened to you, then you returned to the street of Ponyville, with his two sunglasses and ... Wait ... How are you How are those things going on? "
...
translate Engrish easyflutterdash_c610938f:
    ...
    p "Yes, I can not be a fool in the world, but I can not concentrate on physical activity."
...
translate Engrish easyflutterdash_2faa68c9:
    ...
    "Yes, no, that's a moment I was surprised, I was looking around to go to Derkee, because he also asked me!"

# game/Scripts/dashcloud.rpy:149
translate Engrish easyflutterdash_ae2d537e:

    # p "Really? Can I join you?"
    p "Yes, can I join you?"
...
translate Engrish easyflutterdash_9ddaf9d0:
    ...
    rd "I do not think it will think, yes, yes, but! But first of all, we should find it."
...
translate Engrish easyflutterdash_68b25803:
    ...
    p "Is he not there, at the table before you?"
...
translate Engrish easyflutterdash_efb20066:
    ...
    rd "..... \ n ..... \ n Nooooo. Yes, you can think of this ... This ... not so, I'm not fooling."
...
translate Engrish easyflutterdash_3ea3283e:
    ...
    "Even though you're moving a little, Rainbow Dash gives you a piece of meat!"
...
translate Engrish easyflutterdash_33c5e109:
    ...
    rd "I'll ... Erm .You will look forward to returning here as soon as you're ready to go."

# game/Scripts/dashcloud.rpy:162
translate Engrish easyflutterdash_3ccab5bb:

    # p "Ooookay... See you later, then."
    p "Ooookay ... Lee you later, then."
...
translate Engrish easyflutterdash_100342ca:
    ...
    "So you're back on the road to the road, making it bigger."
...
translate Engrish easyflutterdash_ccb93bbd:
    ...
    "You go back to the rainbow of the Rainbow, but instead, you are stumbling with Derpy Hooves, gray and yellow ... Look."
...
translate Engrish derpyabuse_e2663b37:
    ...
    p "I'm not Rainbow Dash, I'm just ... A fan. Yeah, a hardcore fan, cosplaying is like it and everything."
...
translate Engrish derpyabuse_fb11b1df:
    ...
    rd "I'm happy, and I too! But muffins! I'm Derpy Hooves, what's your name?"
...
translate Engrish derpyabuse_6e7ca0fc:
    ...
    "Well, why not call me Rainbow Dash as long as I'm talking?"
...
translate Engrish truederpyabuse_d5aa4191:
    ...
    "Then he kissed and saw the time for the rest of the day, and Dashie joined you as soon as he returned, thinking that it was appropriate to replace the previous training."
...
translate Engrish truederpyabuse_40202db6:
    ...
    "There are other games if you want to perform a showcase."
...
translate Engrish truederpyabuse_248944c5:
    ...
    "I love them! But do you see the real rainbow the rainbow?"
...
translate Engrish truederpyabuse_abbefd25:
    ...
    rd "Is it anything, you come to my house, think it's me, and try to hurt my friends? GET OUT!"
...
translate Engrish truederpyabuse_ba5260a6:

    # d "Hey [playername2]! Rainbow Dash and me were going to go train for a bit, do you want to join us?"
    rd "Hey [nameername2] Rainbow Dash and I'm going to drive for a little, do you want to join us?"
...
translate Engrish truederpyabuse_b91fd848:
    ...
    "I think you'll say the same thing, but it will soon be back."
...
translate Engrish truederpyabuse_5aaaf352:
    ...
    rd "I do not know, I want to eat one, but remember that he was the judge, but I decided to eat it, but ... I can not find it!"
...
translate Engrish truederpyabuse_b4e6dcb6:
    ...
    "Well, we'll buy you, Sugarcube Corner is not near."
...
translate Engrish truederpyabuse_26404882:
    ...
    "That's the last one for today, they have industrial problems and can not do some tomorrow ..."
...
translate Engrish truederpyabuse_3bb97d7b:
    ...
    "At that point, Pinkie gave it to me earlier."
...
translate Engrish yummymuffin_251aca32:
    ...
    "Well, Well, let's go, what do you think?"
...
translate Engrish yummymuffin_c67e549a:
    ...
    "Three of you kept talking while you were leaving."
...
translate Engrish yummymuffin_c4adac6b:
    ...
    "Three of you go out of the ponyville to get a train for a little, pick up heavy, run, plane, etc. Afterward you are happy to greet the other two- go back to their home-and come back across the street. "
...
translate Engrish yummymuffin_0adfd453:
    ...
    "Back to the bottom of the rainbow, a young athlete plays here, drinking water as water flows out."
...
translate Engrish yummymuffin_c1d57a63:
    ...
    rd "Here's where I'm going to wash the water, want to go with me?"
...
translate Engrish yummymuffin_afde9838:
    ...
    "Both of you enter the baths, enough for two young adults to enter and wash themselves without touching each other, because it is good to save water, but it's better to do it while honoring your own space. "
...
translate Engrish yummymuffin_390a9618:
    ...
    "I think about anything, why not anyone here?"
...
translate Engrish yummymuffin_ae7b114b:
    ...
    p "No, what I say, anything like a barbie ballot there."
...
translate Engrish yummymuffin_fbc37a88:
    ...
    "Do not you know? We write to the men who are in charge of newsletters and ask them to put on us an easy kid, if I sometimes change my mind about children."
...
translate Engrish yummymuffin_5143d28f:
    ...
    "I'm trying to update your time. Both of you have a lot of good sports in the afternoon, since you've noticed the great secrets of the game PG."
...
translate Engrish yummymuffin_9421942c:
    ...
    "Or any of your contractual agreements. It is as if contacting sex will only be high in some countries, but for more it's about 7+."
...
translate Engrish yummymuffin_d5421b1d:
    ...
    "Dash Dash is not there. It will be an attractive thing to wait on her bed."
...
translate Engrish strings:
    ...
    new "Take advantage of that opportunity"

    # Scripts\dashcloud.rpy:191
    old "\"I have a very special muffin for you...\""
    new "\"I have a real muffin for you ...\""
