...
translate Engrish sugarcubecorner_12ebd877:
    ...
    "Bakery arrival immediate, pink equine.... Pause. Pinkie Pie location?"
...
translate Engrish sugarcubecorner_9e6f8615:
    ...
    "...Thought negation. Kitchen attempt possibility?"

# game/Scripts/sugarcubecorner.rpy:22
translate Engrish sugarcubecorner_d706f410:

    "Arrival at- DEITY MINE WHAT OBJECT?!"

# game/Scripts/sugarcubecorner.rpy:27
translate Engrish sugarcubecorner_7baa6336:

    pp "New alicorn reception! Pause. Alicorn choice negation, mere [playername!t]? Speed, awesomeness, coolness possession, however alicorn potential realization? Great power possession, correct?"

# game/Scripts/sugarcubecorner.rpy:29
translate Engrish sugarcubecorner_867b7119:

    pp "New alicorn reception! Pause. Alicorn choice negation, mere self? Realization: self-mimicry necessity absence for action similarity, alicorn potential existence? Great power possession?"

# game/Scripts/sugarcubecorner.rpy:31
translate Engrish sugarcubecorner_b63c3a23:

    pp "New alicorn reception! Pause. Alicorn choice negation, mere [playername!t]? Fashion beauty affection possibility, however alicorn potential realization? Great power possession?"

# game/Scripts/sugarcubecorner.rpy:33
translate Engrish sugarcubecorner_b1b01aff:

    pp "New alicorn reception! Pause. Alicorn choice negation, mere [playername!t]? Animal stuff affection possibility, however alicorn potential realization? Great power possession?"

# game/Scripts/sugarcubecorner.rpy:35
translate Engrish sugarcubecorner_fb13aef5:

    pp "New alicorn reception! Pause. Alicorn choice negation, mere [playername!t]? Simple lifestyle preference veracity vs alicorn power?"

# game/Scripts/sugarcubecorner.rpy:37
translate Engrish sugarcubecorner_f54ac078:

    pp "New alicorn reception! Pause. Alicorn choice negation, mere [playername!t] pre-ascension? Or future ascension. Timeline location knowledge difficulty, fangame status... Development years duration! Hiatus years inclusion, however. Own alicorn potential realization? Great power possession?"

# game/Scripts/sugarcubecorner.rpy:40
translate Engrish sugarcubecorner_241f55da:

    p "Attempt absence. Reason query?"

# game/Scripts/sugarcubecorner.rpy:42
translate Engrish sugarcubecorner_a387f315:

    p "Single attempt, Colgate desire absence, [playername2!t] selection result."

# game/Scripts/sugarcubecorner.rpy:44
translate Engrish sugarcubecorner_aa70b176:

    p "Attempt count [alichoice]! However Colgate super alicorn OC permission denial."

# game/Scripts/sugarcubecorner.rpy:46
translate Engrish sugarcubecorner_7224db11:

    # "Wait, you two, couldn't you act normally?"
    "Pause, dyad, normality action inability?"

# game/Scripts/sugarcubecorner.rpy:47
translate Engrish sugarcubecorner_419cf7ef:

    pp "Normality definition? Your standard or player expectation unknown portion standard?"

# game/Scripts/sugarcubecorner.rpy:48
translate Engrish sugarcubecorner_90e9cec9:

    p "Binary option, narrator character communication prohibition, storytelling law disrespect."

# game/Scripts/sugarcubecorner.rpy:49
translate Engrish sugarcubecorner_5fc1d59b:

    # "Fine... Fine... But I warned you."
    "Agreement... Agreement... Warning issuance."
...
translate Engrish sugarcubecorner_05eda021:
    ...
    pp "Warning reception? Topic? Self-proofreading pre-demo release query?"

# game/Scripts/sugarcubecorner.rpy:51
translate Engrish sugarcubecorner_0b22d2fc:

    p "Transition, Pinkie, mustache rationale existence?"

# game/Scripts/sugarcubecorner.rpy:52
translate Engrish sugarcubecorner_28ef7c5a:

    pp "Negation, mustache question pun negation, joke repetition status."
...
translate Engrish sugarcubecorner_1ea90529:
    ...
    pp "Address negation... Transition, sugar cube pie baking mustache usage habit, removal capability!"
...
translate Engrish pinkieguess_948a0525:
    ...
    pp "Possession: muffins, cupcakes, love only! Pause... Desire query?"

# game/Scripts/sugarcubecorner.rpy:215
translate Engrish pinkieguess_3a45e321:

    # pp "Be assertive! You are not Fluttershy!"
    pp "Assertiveness command! Fluttershy identity negation!"
...
translate Engrish assertivepie_360e3c59:
    ...
    p "Cupcake desire. Certainty absolute."
...
translate Engrish assertivepie_149fe2f9:
    ...
    pp "Apology! Ignorance duration until present, recurrence negation!"

# game/Scripts/sugarcubecorner.rpy:253
translate Engrish assertivepie_54d2f4af:

    "Indifference. Future visual contact, memory absence anyway."
...
translate Engrish assertivepie_6d63c2d1:
    ...
    pp "Normality maximum self! Heart cross, fly hope, cupcake eye stick!"
...
translate Engrish assertivepie_af366327:
    ...
    p "Pause, possession existing, gratitude self."
...
translate Engrish assertivepie_22f189cd:
    ...
    p "Pause, self intent identical query, honesty condition."

# game/Scripts/sugarcubecorner.rpy:294
translate Engrish assertivepie_f2a4ad76:

    pp "Hesitation. Case condition, sugar cube pie fabrication proposal? Excitement sound quality?"
...
translate Engrish assertivepie_ec00ff84:
    ...
    p "Sugar bloodstream quantity sufficiency query?"
...
translate Engrish assertivepie_ec1c468f:
    ...
    p "Pause... Harm impossibility hypothesis. Baking specific."

# game/Scripts/sugarcubecorner.rpy:303
translate Engrish assertivepie_cd7ce1ed:

    # pp "Okey-dokey-lokey! Let's go!"
    pp "Affirmative-affirmative-affirmative! Movement initiation!"
...
translate Engrish assertivepie_ce32277b:
    ...
    pp "Negation. Bell sound dingeling-ding-ding case condition, yell capability existence."
...
translate Engrish assertivepie_73739c39:
    ...
    pp "Hope: wood consumption negation, building sale status negative!"
...
translate Engrish assertivepie_b0484d4a:
    ...
    pp "Idea goodness! However baking priority. Gratitude."
...
translate Engrish assertivepie_d9b52f75:
    ...
    pp "Sugar cube insufficiency! Face identification: \"sugar cube absence\". Knowledge importance, yelling singing laughing face identity."

# game/Scripts/sugarcubecorner.rpy:334
translate Engrish assertivepie_c15e6428:

    # p "I have this one on me if that can help."
    p "Possession single unit, help possibility condition."

# game/Scripts/sugarcubecorner.rpy:343
translate Engrish assertivepie_37b4a9ea:

    # p "I can get some if you want."
    p "Acquisition capability self, desire condition."

# game/Scripts/sugarcubecorner.rpy:346
translate Engrish assertivepie_f08fbd8f:

    pp "Idea greatness! Wait location determination. Or sales activity return duration, speed necessity! Disappointment desire negation equine stock absence notification!"

# game/Scripts/sugarcubecorner.rpy:347
translate Engrish assertivepie_5f660f11:

    # p "I'll be back soon, don't worry."
    p "Return imminence, worry prohibition."
...
translate Engrish assertivepie_cf91e0f9:
    ...
    pp "Exclamation. Worry negation, attempt continuation! Mare stallion friendliness sufficiency donation hypothesis! Luck goodness!"
...
translate Engrish assertivepie_9bd798dc:
    ...
    pp "Veracity? Megaphone usage cessation necessity!"
...
translate Engrish bake_pie_2d592439:
    ...
    pp "Greatness! Oven insertion time!"
...
translate Engrish bake_pie_44af9261:
    ...
    pp "Client detection! Sales activity desire or completion location?"
...
translate Engrish sell_bake_fb70dbc2:
    ...
    # pp "Okey-dokey-lokey!"
    pp "Affirmative-affirmative-affirmative!"
...
translate Engrish sell_bake_2f169d1c:
    ...
    pp "Return capability temporal future, desire condition! Sweet donation capability, gratitude proper expression!"
...
translate Engrish sell_bake_27af80e0:
    ...
    pp "Affirmative, statement precision recent! Present enjoyment initiation the-"
...
translate Engrish sell_bake_d47e5c0a:
    ...
    pp "Care entity query? Ending acquisition self, amusement additional possession command!"
