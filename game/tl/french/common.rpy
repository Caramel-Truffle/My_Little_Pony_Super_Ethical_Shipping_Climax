...
translate french strings:
    ...
    new "Saubegarde rapide complétée."
...
translate french strings:
    ...
    new "%(version)s console, originallement par Shiz, C, et delta.\n"

    # renpy/common/00console.rpy:180
    old "Press <esc> to exit console. Type help for help.\n"
    new "Appuyez sur <esc> pour quitter la console. Appuyer sur aide pour de l'aide.\n"

    # renpy/common/00console.rpy:184
    old "Ren'Py script enabled."
    new "Ren'Py script activé."

    # renpy/common/00console.rpy:186
    old "Ren'Py script disabled."
    new "Ren'Py script désactivé."

    # renpy/common/00console.rpy:392
    old "help: show this help"
    new "Aide: montre cette aide"
...
translate french strings:
    ...
    new "Les changements prendront effet au prochain redémarrage."

    # renpy/common/00gltest.rpy:130
    old "Performance Warning"
    new "ALERTE PERFORMANCE"
    ...
    new "Cet ordinateur n'utilise pas les ombrages."

    # renpy/common/00gltest.rpy:139
    old "This computer is displaying graphics slowly."
    new "Cet ordinateur est graphiquement lent."
...
translate french strings:
    ...
    new "Êtes-vous sûr de vouloir remplacer votre sauvegarde?"

    # renpy/common/00layout.rpy:442
    old "Loading will lose unsaved progress.\nAre you sure you want to do this?"
    new "Charger assassinera impitoyablement votre progression si elle n'a pas été sauvegardée.\nÊtes-vous sûr de vouloir faire ça?"

    # renpy/common/00layout.rpy:443
    old "Are you sure you want to quit?"
    new "Voulez-vous vraiment quitter?"
